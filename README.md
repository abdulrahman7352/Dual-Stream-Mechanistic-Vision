...
| Condition | Accuracy | Description |
|-----------|----------|-------------|
| **Clear** | **56.39%** | Standard images |
| **Blur** | **37.05%** | Heavy Gaussian blur (radius=3) |
| **Sharp** | **32.24%** | FFT high-pass (edges only) |

---

## Observations

- The model maintains **strong robustness under blur (37.05%)**, unlike standard CNNs.
- Performance degrades **gradually**, similar to human vision.
- Works reasonably well across **100 classes**, despite increased complexity.

---

## Classification Report (Blur Condition)

- **Accuracy:** 37%  
- **Macro Avg (Precision / Recall / F1):** 0.38 / 0.37 / 0.36  
- **Weighted Avg:** 0.38 / 0.37 / 0.36  

Shows balanced performance across many classes, with stronger performance on **structural categories** (vehicles, landscapes).

---

### Validation Images (Mechanistic)

![Psychometric](results/mech/cifar100/psychometric_curve_mechanistic.png)
![Confusion Matrix](results/mech/cifar100/confusion_matrix_mechanistic.png)
![Grad-CAM](results/mech/cifar100/gradcam_mechanistic.png)
...
- Baseline performs well on clean data (**82%**)
- Completely collapses under blur (**2.65% accuracy**)
- Strong **texture bias**, no shape understanding
...
- **Accuracy:** 3%  
- **Macro Avg:** 0.04 / 0.03 / 0.01  

 Severe collapse — most classes not predicted at all :contentReference[oaicite:0]{index=0}  

---

### Validation Images (Baseline)

![Psychometric](results/baseline/cifar100/psychometric_curve_baseline.png)
![Confusion Matrix](results/baseline/cifar100/confusion_matrix_baseline.png)
![Grad-CAM](results/baseline/cifar100/gradcam_baseline.png)

---

# Head-to-Head Comparison (CIFAR-100)

| Condition | Mechanistic | Baseline | Difference |
|-----------|------------|----------|------------|
| **Clear** | 56.39% | 82.42% | -26% |
| **Blur** | **37.05%** | **2.65%** | **+34.4%** |
| **Sharp** | 32.24% | 52.59% | -20% |

---

## Key Insight

> The mechanistic model is **~14× more robust under blur** than ResNet50.

- Baseline collapses due to **texture dependence**
- Mechanistic model survives using **shape + predictive coding**

---

### Comparison Visualizations

![Psychometric](results/comparison/cifar100/psychometric_curve_compare.jpeg)
![Confusion Matrix](results/comparison/cifar100/confusion_matrix_compare.jpeg)
![Grad-CAM](results/comparison/cifar100/gradcam_compare.jpeg)
...
- **CNNs = high accuracy but fragile**
- **Biological models = robust and resilient**

Scaling to CIFAR-100 strengthens the conclusion:
> Shape-based + predictive coding architectures generalize better under real-world degradation.
